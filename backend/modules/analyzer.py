...
PCC_MARKERS: dict[int, list[dict]] = {
    3: [
        ...
        {"id": "3.05", "text": "コーチはクライアントとの相性・協働関係が適切かを確認する（ICF 2025年追加）"},
    ],
    4: [
    ...
    6: [
        ...
        {"id": "6.06", "text": "コーチはセッション間のトレンド・パターンを把握し、現セッションの傾聴に活用する（ICF 2025年追加）"},
    ],
    7: [
        ...
        {"id": "7.08", "text": "コーチはクライアントの現在・将来の行動・思考・感情パターンに影響する要因を特定する（ICF 2025年追加）"},
    ],
    8: [
...
1. ICF PCC Markers（2021年改訂版）およびICFコアコンピテンシー（2025年改訂版）を評価軸に使用すること
